...
export const personalProjects: Project[] = [
  {
    title: "Fluxus",
    description:
      "一款用 Rust 语言编写的轻量级流处理引擎，旨在实现高效的实时数据处理与分析。",
    image: "/images/projects/fluxus.png",
    tags: ["Web3", "Rust", "Fluxus", "Stream Processing"],
    github: "https://github.com/lispking/fluxus",
    demo: "https://crates.io/crates/fluxus",
    type: "personal",
  },
  {
    title: "Gas Dog",
  ...
  },
  {
    title: "Rust Tips",
    description:
      "分享实用的 Rust 编程技巧和示例代码，帮助开发者提升 Rust 编程技能。深耕技术领域，将知识分享给更多人。",
...
export const contributedProjects: Project[] = [
  {
    title: "OHW",
    description:
      "OHW ELF是一款开源硬件钱包，打破供应商锁定的限制，支持来自多家制造商的数百种芯片，其中最低成本的芯片仅售0.3美元。它兼容性强，适配多种硬件架构，针对资源受限设备优化，从设计之初就将安全性纳入考量。此外，还提供蓝牙、WiFi功能及屏幕等可选配置，能满足多样化需求 。 ",
  ...
  },
  {
    title: "Amphitheatre",
    description:
      "Amphitheatre是一个开源开发者平台，全力助推应用程序与微服务的持续开发进程。借助它，你能够在本地对应用程序源代码进行迭代优化，随后轻松将其部署至本地或远程的Kubernetes集群，操作过程如同执行“docker build && kubectl apply” 或 “docker-compose up”这般便捷流畅。 ",
  ...
  },
  {
    title: "Sui",
    description:
      "Sui 是一个下一代智能合约平台，具有高吞吐量、低延迟的特点，并且拥有一个由 Move 编程语言驱动的面向资产的编程模型。",
  ...
  },
  {
    title: "Rooch",
    description:
      "Rooch是一种适用于比特币生态系统、采用Move语言的虚拟应用程序容器。 ",
  ...
  },
  {
    title: "Rig",
    description:
      "Rig是一个Rust库，用于构建可扩展、模块化且符合人体工程学（即易用性好）的大语言模型驱动的应用程序。 ",
  ...
  },
  {
    title: "Eliza 🤖",
    description:
      "Eliza 是一个简单、快速且轻量级的人工智能代理框架。为所有人提供灵活、可扩展的人工智能代理。  ",
