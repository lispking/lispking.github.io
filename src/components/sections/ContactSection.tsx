          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <a href="https://github.com/lispking" target="_blank" rel="noopener noreferrer" className="text-gray-900 dark:text-gray-100 hover:text-purple-600 dark:hover:text-purple-400">
                        github.com/lispking
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center">
                    <div className="w-12 h-12 rounded-full bg-green-100 dark:bg-green-900/40 flex items-center justify-center mr-4">
                    ...
                    <div>
                      ...
                      <a href="https://x.com/lispking" target="_blank" rel="noopener noreferrer" className="text-gray-900 dark:text-gray-100 hover:text-purple-600 dark:hover:text-purple-400">
                        @lispking
                      </a>
                    </div>
                  </div>
              ...
              <div className="flex flex-col justify-center items-center">
                ...
                <div className="mt-4 relative w-48 h-48 rounded-xl overflow-hidden border-4 border-green-100 dark:border-green-900/40 shadow-lg hover:shadow-2xl transition-shadow duration-300">
                  <Image
