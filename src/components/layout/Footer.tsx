    ...
    <footer className="bg-gray-50 dark:bg-gray-900 py-12">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4 mt-6">
              <a href="https://github.com/lispking" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400">
                <FiGithub className="h-6 w-6" />
              </a>
              <a href="https://x.com/lispking" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/projects" className="text-gray-600 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400">
                  项目
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="flex flex-col items-start space-y-3">
              ...
              <div className="relative w-32 h-32 rounded-lg overflow-hidden border-2 border-green-100 dark:border-green-900/40 shadow-md hover:shadow-xl transition-shadow duration-300">
                <Image
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 mt-12 pt-8 text-center text-gray-600 dark:text-gray-400">
          <p>© {currentYear} King. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
