...
在[Robius：用 Rust 开发多平台应用](https://lispking.github.io/2023/10/15/rust-robius-project-update/)一文介绍了 Robius 的愿景和未来的一些规划，Robius 是一个完全开源的、去中心化的、由社区驱动的项目，旨在让 Rust 成为多平台应用开发的理想选择，本章节，我们一起来解刨 Robius 里的 `Wechat` 应用 Demo。
...
* `cargo-makepad`工具安装成功后，可根据所需平台安装工具链，相关命令如下：
    ```shell
